...
export function ClienteList() {
  ...
  function handleVerDetalle(cliente: Cliente) {
    navigate({ to: '/clientes/gestion/$clienteId', params: { clienteId: cliente.id } })
  }
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted">
                  ...
                  <th className="text-right px-4 py-3 font-medium text-muted-foreground">Limite</th>
              ...
              <tbody>
                {clientesFiltrados.map((cli) => {
                  ...
                  return (
                    ...
                    <tr
                      className="border-b border-border transition-colors cursor-pointer hover:bg-muted/50"
                      onClick={() => handleVerDetalle(cli)}
                    >
