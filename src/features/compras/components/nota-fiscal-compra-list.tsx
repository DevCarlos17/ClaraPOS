    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold text-gray-900">
          ...
          <span className="text-sm font-normal text-gray-500 ml-2">({notas.length})</span>
        </h2>
        <button
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="text-left px-4 py-3 font-medium text-gray-700">Nro Documento</th>
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-700">Afecta Inv.</th>
              </tr>
            </thead>
            <tbody>
              {notas.map((nota: NotaFiscalConProveedor) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 font-mono text-gray-900">{nota.nro_documento}</td>
                  <td className="px-4 py-3 text-gray-900">{nota.proveedor_nombre}</td>
                  <td className="px-4 py-3 text-gray-600 max-w-[200px] truncate" title={nota.motivo}>
                    {nota.motivo}
                  </td>
