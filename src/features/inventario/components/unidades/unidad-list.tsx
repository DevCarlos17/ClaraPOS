...
import { Plus, PencilSimple, Printer, Package } from '@phosphor-icons/react'
import {
  useUnidades,
  actualizarUnidad,
      ...
      <div className="flex flex-wrap justify-between items-center gap-2 mb-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 disabled:opacity-50 transition-colors cursor-pointer"
          >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted">
                ...
                <th className="text-left px-4 py-3 font-medium text-muted-foreground">Abreviatura</th>
                <th className="text-left px-4 py-3 font-medium text-muted-foreground">Decimal</th>
            ...
            <tbody>
              {unidades.map((u) => (
                <tr key={u.id} className="border-b border-border hover:bg-muted/50 transition-colors">
                  ...
                  <td className="px-4 py-3 font-mono">{u.abreviatura}</td>
