...
import { useTopProductos, type CuadreFilters } from '../hooks/use-cuadre'

interface TopProductosProps {
  filters: CuadreFilters
}

export function TopProductos({ filters }: TopProductosProps) {
  const { productos, isLoading } = useTopProductos(filters)
