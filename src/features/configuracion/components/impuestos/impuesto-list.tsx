          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="text-right px-4 py-3 font-medium text-gray-700">Porcentaje</th>
                <th className="text-left px-4 py-3 font-medium text-gray-700">Codigo SENIAT</th>
            ...
            <tbody>
              {impuestos.map((imp) => (
                <tr key={imp.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 text-gray-900">{imp.nombre}</td>
                  ...
                  <td className="px-4 py-3 text-gray-600">{imp.codigo_seniat ?? '—'}</td>
                  <td className="px-4 py-3">
                    <button
