...
import { PagoFacturaModal } from '@/features/cxc/components/pago-factura-modal'
...
export function PrestamoDetalleModal({ isOpen, onClose, prestamo }: PrestamoDetalleModalProps) {
  ...
  return (
    ...
    <PagoFacturaModal
      ...
      vencimientos={[prestamo]}
      defaultDestino="PRESTAMO"
      vencimientoInicial={prestamo}
      onSuccess={() => setPagoModalOpen(false)}
    />
    </>
  )
}
