/**
 * Modulo PURO (sin I/O, sin tx) para las decisiones de gating por PIN del
 * modulo Tradicional de Notas de Credito (Slice 5a — openspec/changes/
 * notas-credito/tasks.md 5a.1, Spec notas-credito-pos "Modelo de doble PIN",
 * obs #2802 decision 3).
 *
 * DOS autorizaciones SEPARADAS, NUNCA fusionadas:
 ...
 * Slice 5a-2 (obs #2831, division explicita de slice 5), NO en este slice.
 * Aqui solo se resuelve el VALOR que 5a-2 consumira: `null` si no hay
 * override vigente (el backend sigue el riel automatico sin cambios), o el
 * id explicito elegido cuando el segundo PIN ya autorizo el override.
 */
